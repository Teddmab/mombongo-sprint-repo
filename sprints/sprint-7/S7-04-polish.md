# S7-04 — i18n Polish Animations and Accessibility

## Metadata
| Field | Value |
|-------|-------|
| Story ID | S7-04 |
| Branch | `feature/s7-04-polish` |
| Owner | Moise |
| Estimate | 2h |
...
```bash
git add -A && git commit -m "feat(S7-04): i18n Polish Animations and Accessibility" && git push origin feature/s7-04-polish
```
