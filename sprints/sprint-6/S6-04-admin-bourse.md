# S6-04 — Admin — Bourse Distribution

## Metadata
| Field | Value |
|-------|-------|
| Story ID | S6-04 |
| Branch | `feature/s6-04-admin-bourse` |
| Owner | Afrotouch OU |
| Estimate | 2h |
| Dependencies | S6-01 |
...
```bash
git add -A && git commit -m "feat(S6-04): Admin — Bourse Distribution" && git push origin feature/s6-04-admin-bourse
```
