# S6-02 — Admin — User Management

## Metadata
| Field | Value |
|-------|-------|
| Story ID | S6-02 |
| Branch | `feature/s6-02-admin-users` |
| Owner | Moise |
| Estimate | 2h |
| Dependencies | S6-01 |
...
```bash
git add -A && git commit -m "feat(S6-02): Admin — User Management" && git push origin feature/s6-02-admin-users
```
